...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/client.runtime.js");
/******/ })
/************************************************************************/
/******/ ({
...
var SIGNUP_ORIGIN =  true ? "http://localhost:5050" : undefined;
var isPhone = window.innerWidth < 625;
var LOGIN_URL = SIGNUP_ORIGIN + "/";
var DEFAULT_BITDB_URL = "https://bitdb.bch.sx";
var config = {};
var identity = {};
...
var userRequestManager = {
  ...
  pay: function () {
    var _pay = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(amount, unit) {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", new Promise(function (resolve, reject) {
                var newReqId = uuidv4(); // first set a listener to receive the response back from signer
...
function buildDOMObjects() {
  ...
  var rootDivClassName = Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject(), isPhone ? "5%" : "5%", isPhone ? "5%" : "5%");
  rootDiv.classList.add(rootDivClassName); // load the font

  var link = document.createElement("link");
  link.setAttribute("href", "https://fonts.googleapis.com/css2?family=Poppins:wght@300;400&display=swap");
  ...
  h1.innerText = "SIGNup";
  h1.classList.add(Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject2()));
  var h4 = document.createElement("h4");
  h4.innerText = "Your gateway into the rabbit hole of blockchain";
  h4.classList.add(Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject3()));
  var p = document.createElement("p");
  p.innerText = "Signup is a universal login for blockchain. Create or import a wallet with a few clicks!";
  p.classList.add(Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject4()));
  var button = document.createElement("button");
  button.innerText = "Login with SIGNUP";
  button.classList.add(Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject5()));
  button.addEventListener("click", function () {
    var newReqId = uuidv4(); // open a new popup window or focus the current one

    if (popupWindowRef == null || popupWindowRef.closed) {
      var popupParams = "scrollbars=yes,resizable=yes,status=no,location=yes,toolbar=yes,menubar=no,width=430px,height=700px";
      popupWindowRef = window.open(LOGIN_URL + "?reqId=" + newReqId, "Signup Wallet", popupParams);
      listenForMessage(null, function (payload) {
        if (payload.status === "READY") {
          requestFromUserWallet({
            reqType: "AUTH",
            reqId: newReqId
          });
        }
...
function authenticate() {
  showRootDiv();
  return new Promise(function (resolve, reject) {
    var newReqId = uuidv4(); //requestFromUser({ reqType: "AUTH", reqId: newReqId });
...
function cash(params) {
  ...
  buildDOMObjects(); // origin's BCH address, optional
...
function read() {
  var bitdbURL = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_BITDB_URL;
}
